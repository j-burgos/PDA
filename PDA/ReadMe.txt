========================================================================
   APLICACIÓN: PDA Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación PDA.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación PDA.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado PDA.pch y un archivo de tipos 
